	...
	public static void main (String[] arg) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(Thread thread, Throwable throwable) {
				...
				pw.flush();
				JOptionPane.showMessageDialog(null, "Gloomy Pixel Dungeon has crashed, sorry about that!\n\n" +
						"If you could, please email this error message to me and I'll get it fixed (verylonely@protonmail.ch):\n\n" +
		...
		if (Game.version == null) {
			Game.version = "0.8.1-b-8";
		}
		
		try {
			Game.versionCode = Integer.parseInt(DesktopLauncher.class.getPackage().getImplementationVersion());
		} catch (NumberFormatException e) {
			Game.versionCode = 402;
		}
